...
class Game:
    ...
    def import_assets(self) :
        ...
        pixeloidsans_path = join(base_path, "graphics", "fonts", "PixeloidSans.ttf")
        dogicapixelbold_path = join(base_path, "graphics", "fonts", "dogicapixelbold.otf")
        ...
        self.fonts = {
            'dialog': pygame.font.Font(pixeloidsans_path, 30),
            'regular': pygame.font.Font(pixeloidsans_path, 18),
            'small': pygame.font.Font(pixeloidsans_path, 14),
            'bold': pygame.font.Font(dogicapixelbold_path, 20),
        }
